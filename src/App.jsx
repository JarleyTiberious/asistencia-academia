...
export default function App() {
  ...
  const obtenerDiaSemanaClave = (fechaStr) => {
    // Forzamos el parseo local para evitar desfases de zona horaria
  ...
  // El estado inicial del selector de días ahora se acopla dinámicamente a la fecha actual seleccionada
  ...
  // Actualiza el estado del formulario si cambias la fecha del calendario principal
  useEffect(() => {
